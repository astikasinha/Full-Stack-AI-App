...
const AppContextProvider = (param)=>{
    ...
    const fetchUsersChats = async ()=>{
        try {
            ...
            if (!token) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Unable to fetch auth token. Please try again.");
                return;
            }
    ...
    const createNewChat = async ()=>{
        try {
            ...
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/chat/create", {}, {
                headers: {
                    Authorization: "Bearer ".concat(token)
                }
            });
...
_s1(AppContextProvider, "27jHC0CkVLmq3qtTDaUD5iQ0zTU=", false, function() {
    return [
